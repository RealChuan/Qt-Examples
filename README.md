...
> **QtQuick 版本**：[BatteryQuick](src/BatteryQuick/) - 电池电量显示控件 (QtQuick 版本)
>
...
> **QtQuick 版本**：[ClockQuick](src/ClockQuick/) - 模拟时钟控件（QtQuick 版本）
>
...
> **QtQuick 版本**：[DashBoardQuick](src/DashBoardQuick/) - 仪表盘控件（QtQuick 版本）
>
...
> **QtQuick 版本**：[LoadingIndicatorQuick](src/LoadingIndicatorQuick/) - 加载指示器控件 (QtQuick 版本)
>
> ![QML加载指示器截图](src/LoadingIndicatorQuick/images/loading.png)
>
> **相关控件**：[LoadingOverlayQuick](src/LoadingOverlayQuick/) - 加载覆盖层控件 (QtQuick 版本) — 基于 QtQuick Popup 的轻量级加载覆盖层组件，使用系统原生 BusyIndicator，模态对话框设计
>
...
> **QtQuick 版本**：[SwitchDelegate](https://doc.qt.io/qt-6/zh/qtquickcontrols-customize.html#customizing-switchdelegate) - Qt 官方的开关按钮委托（QtQuick 版本）
...
> **QtQuick 版本**：[CircularProgressQuick](src/CircularProgressQuick/) - 圆形进度条控件（QtQuick 版本）
>
...
- **核心文件**:
  ...
  - [entitlements.plist](src/packaging/macos/entitlements.plist) - 应用程序签名权限配置文件
