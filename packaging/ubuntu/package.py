...
def deploy():
    build.execute(
        ...
        "'/home/fxy/下载/linuxdeployqt-continuous-x86_64.AppImage' MyApp -always-overwrite -no-translations -qmake=/opt/Qt/6.6.2/gcc_64/bin/qmake -unsupported-allow-new-glibc -appimage\n"
    )
