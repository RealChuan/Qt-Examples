...
{
public:
    explicit BatteryWidgetPrivate(BatteryWidget *q) : q_ptr(q) {}
...
void BatteryWidget::initAnimations()
{
...
void BatteryWidget::drawHeader(QPainter &painter, const QRectF &batteryRect)
{
    ...
    QPointF headRectBottomRight(width(), height() - headVerticalMargin);
