...
MainWindow::MainWindow(QWidget *parent) : QMainWindow(parent)
{
    ...
    connect(penColorButton,
            ...
            [this, bubble, penColorButton, updateColorButton]() {
                QColor color = QColorDialog::getColor(
                    bubble->pen().color(), this, tr("Select Border Color"));
                if (color.isValid()) {
                    QPen pen = bubble->pen();
                    pen.setColor(color);
                    bubble->setPen(pen);
    ...
    connect(brushColorButton,
            ...
            [this, bubble, brushColorButton, updateColorButton]() {
                QColor color = QColorDialog::getColor(
                    bubble->brush().color(), this, tr("Select Background Color"));
                if (color.isValid()) {
    ...
    connect(textColorButton,
            ...
            [this, bubble, textColorButton, updateColorButton]() {
                QColor color
                    = QColorDialog::getColor(bubble->textColor(), this, tr("Select Text Color"));
                if (color.isValid()) {
