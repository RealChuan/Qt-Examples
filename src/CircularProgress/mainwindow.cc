...
MainWindow::MainWindow(QWidget *parent) : QMainWindow(parent)
{
    ...
    // 显示设置
    connect(
        showPercentCheck, &QCheckBox::toggled, circularProgress, &CircularProgress::setShowPercent);
    ...
    connect(arcColorButton,
            ...
            [this, circularProgress, arcColorButton, updateColorButton]() {
                QColor color = QColorDialog::getColor(
                    circularProgress->arcColor(), this, tr("Select Arc Color"));
                if (color.isValid()) {
    ...
    connect(textColorButton,
            ...
            [this, circularProgress, textColorButton, updateColorButton]() {
                QColor color = QColorDialog::getColor(
                    circularProgress->textColor(), this, tr("Select Text Color"));
                if (color.isValid()) {
    ...
    connect(titleColorButton,
            ...
            [this, circularProgress, titleColorButton, updateColorButton]() {
                QColor color = QColorDialog::getColor(
                    circularProgress->titleColor(), this, tr("Select Title Color"));
                if (color.isValid()) {
    ...
    connect(baseColorButton,
            ...
            [this, circularProgress, baseColorButton, updateColorButton]() {
                QColor color = QColorDialog::getColor(
                    circularProgress->baseColor(), this, tr("Select Base Color"));
                if (color.isValid()) {
    ...
    connect(backgroundColorButton,
            ...
            [this, circularProgress, backgroundColorButton, updateColorButton]() {
                QColor color = QColorDialog::getColor(
                    circularProgress->backgroundColor(), this, tr("Select Background Color"));
                if (color.isValid()) {
    ...
    connect(
        circularProgress, &CircularProgress::valueReset, this, []() { qDebug() << "Value reset"; });
